      ...
      <div className="relative aspect-[4/5] bg-gray-100 flex items-center justify-center">
        ...
        {images.length > 1 && (
          <>
            <button
              onClick={handlePrev}
              className="absolute left-2 top-1/2 -translate-y-1/2 rounded-full p-2 bg-white/80 hover:bg-white z-10"
            ...
            <button
              onClick={handleNext}
              className="absolute right-2 top-1/2 -translate-y-1/2 rounded-full p-2 bg-white/80 hover:bg-white z-10"
